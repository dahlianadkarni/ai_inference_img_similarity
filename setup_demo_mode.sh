...
echo ""
echo "Terminal 1 (Photos Library - port 8080):"
echo "  source venv/bin/activate"
echo "  python -m src.ui.main"
echo "  → http://127.0.0.1:8080"
echo ""
echo "Terminal 2 (Demo - port 8081 + inference service):"
echo "  source venv/bin/activate"
echo "  python start_services.py --ui-demo"
echo "  → Demo UI: http://127.0.0.1:8081"
echo "  → Inference service: http://127.0.0.1:8002"
echo ""
echo "Both will run (UI on 8081) with the inference service on 8002; they use separate data!"
echo ""
